 ...
 * @access  Admin
 */
orderRouter.get('/admin/all', isAuthenticated,authorizeAdmin("super"), getAllOrders);
 ...
 * @access  Admin
 */
orderRouter.put('/:id/status', isAuthenticated,authorizeAdmin("super"), updateOrderStatus);
